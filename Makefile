# Adapted from the WASM-4 (https://github.com/aduros/wasm4) makefile by Bruno Garcia, permission received to release this modified version under The Unlicense
...
# Linker flags
LDFLAGS = -Wl,-zstack-size=65536,--no-entry,--import-memory -mexec-model=reactor \
